...
using WindowMenuItemText = std::string;
using WindowMenuItemAction = std::function<void( void )>;
using WindowMenuItem = std::pair < WindowMenuItemText, WindowMenuItemAction >;
using WindowMenuItems = std::vector<WindowMenuItem>;
